...
<ReadMore>
  Learn more about [environment variables](/en/guides/environment-variables/)
  and `.env` files in Astro.
</ReadMore>
...
<FileTree title="Project Structure">
  - src/ - pages/ - **builder-preview.astro** - env.d.ts - .env -
...
<FileTree title="Project Structure">
  - src/ - pages/ - index.astro - posts/ - **[slug].astro** - env.d.ts - .env -
  astro.config.mjs - package.json
</FileTree>
