...
<PackageManagerTabs>
  <Fragment slot="npm">```sh npm install flotiq-api-ts ```</Fragment>
  <Fragment slot="pnpm">```sh pnpm add flotiq-api-ts ```</Fragment>
  <Fragment slot="yarn">```sh yarn add flotiq-api-ts ```</Fragment>
</PackageManagerTabs>
...
<PackageManagerTabs>
  <Fragment slot="npm">```sh npm rebuild flotiq-api-ts ```</Fragment>
  <Fragment slot="pnpm">```sh pnpm rebuild flotiq-api-ts ```</Fragment>
  <Fragment slot="yarn">
    ```sh yarn rebuild flotiq-api-ts // for yarn v1 (Classic): // yarn add
    flotiq-api-ts ```
  </Fragment>
</PackageManagerTabs>
