...
<ReadMore>
  Read more about [using JavaScript framework
  components](/en/guides/framework-components/) in your project.
</ReadMore>
...
<ReadMore>
  Read more about [using server islands](/en/guides/server-islands/) in your
  project.
</ReadMore>
